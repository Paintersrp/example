...
var SelectInput = React13.forwardRef(function SelectInput2(props, ref) {
  ...
  var _React$useState = React13.useState(null), displayNode = _React$useState[0], setDisplayNode = _React$useState[1];
  var _React$useRef = React13.useRef(openProp != null), isOpenControlled = _React$useRef.current;
  var _React$useState2 = React13.useState(), menuMinWidthState = _React$useState2[0], setMenuMinWidthState = _React$useState2[1];
  var _React$useState3 = React13.useState(false), openState = _React$useState3[0], setOpenState = _React$useState3[1];
  var handleRef = useForkRef(ref, inputRefProp);
  React13.useImperativeHandle(handleRef, function() {
    return {
  ...
  var childrenArray = React13.Children.toArray(children);
  var handleChange = function handleChange2(event) {
  ...
  return React13.createElement(React13.Fragment, null, React13.createElement("div", _extends({
    ...
    id: buttonId
  }), isEmpty(display) ? React13.createElement("span", {
    dangerouslySetInnerHTML: {
      __html: "&#8203;"
    }
  }) : display), React13.createElement("input", _extends({
    ...
    autoFocus
  }, other)), React13.createElement(IconComponent, {
  ...
  }), React13.createElement(Menu_default, _extends({
    id: "menu-".concat(name || ""),
...
init_createSvgIcon();
var ArrowDropDown_default = createSvgIcon(React14.createElement("path", {
  d: "M7 10l5 5 5-5z"
}), "ArrowDropDown");
...
var NativeSelectInput = React15.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return React15.createElement(React15.Fragment, null, React15.createElement("select", _extends({
    className: clsx_m_default(
      classes.root,
      classes.select,
      classes[variant],
    ...
    disabled,
    ref: inputRef || ref
  }, other)), props.multiple ? null : React15.createElement(IconComponent, {
...
var defaultInput = React16.createElement(Input_default, null);
var NativeSelect = React16.forwardRef(function NativeSelect2(props, ref) {
  ...
  return React16.cloneElement(input, _extends({
...
var NativeSelect_default = withStyles_default(styles19, {
  name: "MuiNativeSelect"
})(NativeSelect);

// node_modules/@material-ui/core/esm/Select/Select.js
var styles21 = styles19;
...
var Select_default = withStyles_default(styles21, {
  name: "MuiSelect"
})(Select);
...
var TextField = React18.forwardRef(function TextField2(props, ref) {
  ...
  if (variant === "outlined") {
    ...
    if (label) {
      ...
      InputMore.label = React18.createElement(React18.Fragment, null, label, displayRequired && " *");
    }
  }
  if (select) {
  ...
  var InputElement = React18.createElement(InputComponent, _extends({
  ...
  return React18.createElement(FormControl_default, _extends({
    className: clsx_m_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    color,
    variant
  }, other), label && React18.createElement(InputLabel_default, _extends({
    htmlFor: id,
    id: inputLabelId
  }, InputLabelProps), label), select ? React18.createElement(Select_default, _extends({
    "aria-describedby": helperTextId,
    id,
    labelId: inputLabelId,
    value,
    input: InputElement
  }, SelectProps), children) : InputElement, helperText && React18.createElement(FormHelperText_default, _extends({
    id: helperTextId
...
true ? TextField.propTypes = {
  ...
  color: import_prop_types15.default.oneOf(["primary", "secondary"]),
  ...
  rows: deprecatedPropType(import_prop_types15.default.oneOfType([import_prop_types15.default.number, import_prop_types15.default.string]), "Use `minRows` instead"),
  rowsMax: deprecatedPropType(import_prop_types15.default.oneOfType([import_prop_types15.default.number, import_prop_types15.default.string]), "Use `maxRows` instead"),
...
var TextField_default = withStyles_default(styles22, {
  name: "MuiTextField"
})(TextField);
...
//# sourceMappingURL=chunk-CB3PBIJW.js.map
